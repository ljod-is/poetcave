...
urlpatterns = [
    ...
    path(
        ...
        ActivationView.as_view(success_url=reverse_lazy("activation_complete")),
        name="activate",
    ),
    # Activation complete.
    path(
    ...
    path(
        ...
        auth_views.PasswordResetView.as_view(
            ...
            html_email_template_name="core/user/mail/password_reset_body.html",
    ...
    path(
        ...
        views.retrieve_data_download,
        name="retrieve_data_download",
    ),
    # Terms and conditions.
    path(
        "terms/accept/",
        AcceptTermsView.as_view(template_name="termsandconditions/terms.html"),
        name="tc_accept_page",
    ),
    path(
    ...
    path("terms/reject/", views.reject_terms, name="tc_reject_page"),
]
